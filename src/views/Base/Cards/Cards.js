...
import {
  ...
  return (
    <div>
      <h4 style={{display: "flex",  alignItems: "center", justifyContent: "center", marginTop: 5}}>Solicitação de Serviço</h4>
      <Button onClick={voltar} color="link">Voltar</Button>
      <br />
      <InputGroup>
        <InputGroupButtonDropdown addonType="prepend" isOpen={splitButtonOpen} toggle={toggleSplit}>
          ...
          <DropdownMenu>
            <DropdownItem>Manutenção de Equipamento</DropdownItem>
            <DropdownItem divider />
            <DropdownItem>Outros serviços</DropdownItem>
          </DropdownMenu>
        </InputGroupButtonDropdown>
        <Input onChangeCapture={splitButtonOpen.value}
        //placeholder="Aguardando..."
        onchange={DropdownItem.value}
         />
        <InputGroupAddon addonType="append"><Button color="secondary">Prosseguir</Button></InputGroupAddon>
      </InputGroup>
    </div>
  );
}
