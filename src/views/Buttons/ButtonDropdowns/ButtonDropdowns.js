...
import { Button, ButtonDropdown, Card,Input, Label, CardBody, CardHeader, Col, DropdownItem, DropdownMenu, DropdownToggle, Row, Container } from 'reactstrap';

const ButtonDropdowns = () => {
  return ( 
  <Container>
    <h4 style={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 20}}>Cadastrar Equipamentos</h4>
    <Row>
        <Col xs="6">
          <Input />
        </Col>
      ...
      <Row>
        <Col style={{marginTop: 10}} sm="3" md={{ size: 4, offset: 8 }}>
